...
for i in range(N_particles):
    plt.plot(x_list[:,i],y_list[:,i],c=color_list[i],linestyle='dashed',linewidth=2)

    plt.scatter(x_list[-1,i],y_list[-1,i],c=color_list[i],s=500)
    plt.scatter(x_list[0,i],y_list[0,i],c=color_list[i],s=500,marker='X')
